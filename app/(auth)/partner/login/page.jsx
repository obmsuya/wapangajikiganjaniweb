// app/(auth)/partner/login/page.jsx
"use client";
...
export default function PartnerLoginPage() {
  ...
  const features = [
    { icon: Users, title: "Referral Tracking", desc: "Monitor your referrals in real-time" },
    { icon: DollarSign, title: "Earnings Management", desc: "Track commissions and payments" },
    { icon: BarChart, title: "Performance Analytics", desc: "Get insights on your referral network" }
  ];
            ...
            >
              ...
              <div className="mb-12">
                ...
                >
                  ...
                  <h1 className="text-2xl font-bold bg-gradient-to-r from-primary-600 to-primary-700 text-transparent bg-clip-text">
                    Wapangaji Kiganjani Partners
                  </h1>
                </motion.div>
                
                <h2 className="text-4xl xl:text-5xl font-bold text-foreground mb-6 leading-tight">
                  Welcome Back to Your
                  <span className="block text-primary-600">Partner Network</span>
                </h2>
                
                <p className="text-lg text-muted-foreground leading-relaxed">
                  Continue growing your referral network. Track earnings, 
                  manage referrals, and expand your partnerships 
                  with confidence.
                </p>
              </div>
            ...
            <Card className="border-0 shadow-2xl bg-card/80 backdrop-blur-sm">
              <CardContent className="p-8">
                ...
                <div className="text-center mb-8">
                  <h3 className="text-2xl font-bold text-foreground mb-2">Partner Sign In</h3>
                  <p className="text-muted-foreground">Access your partner dashboard</p>
                </div>
