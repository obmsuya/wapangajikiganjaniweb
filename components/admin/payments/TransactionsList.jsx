      ...
      {isClient && (
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <Card className="p-3">
            ...
            <div className="text-2xl font-bold">{formatCurrency(summary.subscriptionAmount || 0)}</div>
          </Card>
          
          <Card className="p-3">
            <div className="text-sm text-gray-500">Rent Revenue</div>
            <div className="text-2xl font-bold">{formatCurrency(summary.rentAmount || 0)}</div>
          </Card>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div>
            ...
            <Select
              ...
              onValueChange={(value) => updateFilters({ payment_type: value })}
            >
